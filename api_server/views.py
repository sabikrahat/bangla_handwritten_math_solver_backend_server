...
def equation_solve(request):
    if request.method == 'GET':
        response_data = {'status': True, 'message': 'Equation Solve Function executed without any data...!', 'data': None, }
        return Response(response_data, status=status.HTTP_200_OK)
        ...
        try:
            ...
            res = get_equation_and_solve(img_equ, img_ans, info)
...
def get_equation_and_solve(img_equ, img_ans, info):
    print("::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    print("::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    print(":::::::: Request from " + info + " ::::::::")
    print("::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    ...
    res_equ = get_predict_equation('outputs/equ/1_equ_canvas_from_app_.png', 'equ')
    print("::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    print(":::::::: Equation Predicted ::::::::", res_equ)
    print("::::::::::::::::::::::::::::::::::::::::::::::::::::::::")

    res_ans = get_predict_equation('outputs/ans/1_ans_canvas_from_app_.png', 'ans')
    print("::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
...
def get_predict_equation(path, name):
    ...
    cv2.imwrite("outputs/" + name + "/3_black_and_white_noise_remove.jpg", blackAndWhiteImage)
    ...
    for i, c in enumerate(contours):
        ...
        if x > 0 and y > 0 and w > 20:  # cheaking weather any garbage value detecting
            ...
            label = labels[pred[0]]
            print('>>>>The {} no object detected as : {}'.format(i, label))
            chars.append(label)
    ...
    try:
        ...
        print('Value of the equation predicted {} and answer is {}'.format(e, v))
        return '{}={}'.format(e, v)
